...
const Login = () => {
  ...
  return (
    ...
    <Link to="/forgot-password" className="text-xs text-blue-300 hover:text-purple-300">
      Forgot Password?
    </Link>
  </div>
            </div>
            ...
            <div className="flex items-center justify-center gap-6 mt-6">
              ...
              <button type="button" className="bg-purple-900/40 cursor-pointer p-2 rounded-full border border-purple-700/30 hover:bg-purple-800/40 transition">
                <svg className="w-5 h-5 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
