...
//       <nav className="  backdrop-blur-xl  text-white px-4 py-3 ">
...
//                   <span className="absolute -top-2 -right-4 text-xs text-white bg-purple-600 px-1.5 rounded-md">
//                     New
//                   </span>
//                 )}
//               </li>
...
//         {/* Mobile Menu */}
//         {open && (
//   <ul className="md:hidden mt-3 space-y-2 text-lg text-white">
//     {links.map((link) => (
...
//           {link.name}
//           {link.name === "Playground" && (
//             <span className="ml-2 text-xs bg-purple-600 px-1.5 rounded-md">
//               New
//             </span>
//           )}
//         </Link>
...
//           navigate("/assistant");
//         }}
//         className="flex items-center bg-transparent border border-purple-500 text-purple-400 px-3 py-1 rounded-md text-sm mt-2"
//       >
//         💡 AI Assistant
